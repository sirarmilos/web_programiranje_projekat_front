<template>
    ...
    <div class="container-fluid w-100 pt-5 hv-100 pb-4" style="background-color: #eee; border: 5px solid white;">
        ...
        <div id="prozorGreski" class="pt-5 pb-3" hidden>
...
export default {
  ...
  mounted: function () {
      ...
      axios
      .get("http://localhost:8081/api/porudzbina/MenadzerUrestoranu",
      {
  ...
  methods: {
    ...
    dugmeUPripremi : function(id) {
        ...
        axios
        .put("http://localhost:8081/api/porudzbina/izmenaStatusaUPripremi/" + id,
        {
          withCredentials: true
        })
        .then((res) => {
    ...
    dugmeCekaDostavljaca : function(id) {
        ...
        axios
        .put("http://localhost:8081/api/porudzbina/izmenaStatusaCekaDostavljaca/" + id,
        {
          withCredentials: true
        })
        .then((res) => {
